...
client.on("messageCreate", async (message) => {
    ...
    if (!message.author.bot) {
        ...
        if (afkset.has(message.author.id + `_${message.guildId}`, function(callback){ callback === true })) {
        ...
        if (mentionget) {
            if (afkset.has(mentionget.id + `_${message.guildId}`, function(callback){ callback === true })) {
